...
/***/ 251:
/*!*****************************************************************************!*\
  !*** C:/Users/IT/Desktop/共享旅途/mini/main.js?{"page":"pages%2Fmine%2Findex"} ***!
  \*****************************************************************************/
...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/mine/index.vue */ 252));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/***/ 252:
/*!**********************************************************!*\
  !*** C:/Users/IT/Desktop/共享旅途/mini/pages/mine/index.vue ***!
  \**********************************************************/
/*! no static exports found */
...
/* harmony import */ var _index_vue_vue_type_template_id_4bd6864f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=4bd6864f& */ 253);
...
/***/ 253:
/*!*****************************************************************************************!*\
  !*** C:/Users/IT/Desktop/共享旅途/mini/pages/mine/index.vue?vue&type=template&id=4bd6864f& ***!
  \*****************************************************************************************/
...
/***/ 255:
/*!***********************************************************************************!*\
  !*** C:/Users/IT/Desktop/共享旅途/mini/pages/mine/index.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var _default =
{
  ...
  methods: {
    /**
              * 退出登录
              */
    loginOut: function loginOut() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var self;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                self = _this;
                self.$message.confirm('确认退出登录?', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _yield$self$$http$get, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                            self.$http.get('login/out'));case 2:_yield$self$$http$get = _context.sent;res = _yield$self$$http$get.data;if (!(
                          res.code !== 200)) {_context.next = 6;break;}return _context.abrupt("return", self.$message.toast(res.msg));case 6:
                          self.$db.del('token');
                          self.toLogin();case 8:case "end":return _context.stop();}}}, _callee);})));case 2:case "end":return _context2.stop();}}}, _callee2);}))();
    ...
    /**
        * 跳转到车主认证
        */
    toCertification: function toCertification() {
    ...
    /**
        * 跳到我的订单
        */
    toMyIndent: function toMyIndent() {
    ...
    /**
        * 跳转到提现明细
        */
    toWithdrawDetail: function toWithdrawDetail() {
    ...
    /**
        * 判断是否登录
        */
    checkLogin: function checkLogin() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var _yield$_this2$$http$g, res;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:if (!
                _this2.$db.get('token')) {_context3.next = 13;break;}_context3.next = 3;return (
                  _this2.$http.get('mine/index'));case 3:_yield$_this2$$http$g = _context3.sent;res = _yield$_this2$$http$g.data;if (!(
                res.code !== 200)) {_context3.next = 7;break;}return _context3.abrupt("return", _this2.$message.toast(res.msg));case 7:
                if (res.data.is_owner !== '0') {
                  _this2.money = res.data.money;
                  _this2.withdraw_money = res.data.withdraw_money;
                }
                _this2.nickname = res.data.nickname, _this2.photo = res.data.photo, _this2.is_owner = res.data.is_owner, _this2.sex = res.data.sex;
                _this2.mobile = res.data.mobile;
                _this2.isLogin = true;_context3.next = 14;break;case 13:

                _this2.money = '0.00', _this2.withdraw_money = '0.00', _this2.isLogin = false;case 14:case "end":return _context3.stop();}}}, _callee3);}))();
...
/***/ 257:
/*!********************************************************************************************!*\
  !*** C:/Users/IT/Desktop/共享旅途/mini/pages/mine/index.vue?vue&type=style&index=0&lang=scss& ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
