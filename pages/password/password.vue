		...
		<view class="wrapper">
			<view class="input-content">
				...
				<view class="cu-form-group" style="border: 2upx solid whitesmoke;margin-bottom: 20px;border-radius: 30px">
					...
					<input type="number" :value="code" placeholder="请输入验证码" maxlength="6" data-key="code" @input="inputChange" @confirm="toPassword" />
			...
			<button class="confirm-btn" @click="toPassword">立即找回</button>
		</view>
		<!-- 滑动验证码 -->
